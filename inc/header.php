            ...
            <form>
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <button type="submit" class = "btn btn-dark shadow-none" data-bs-dismiss="modal">Login</button>
        ...
        <div class="modal-content">
            <form>
                ...
                <div class="modal-body">
                    ...
                    <button type="submit" class = "btn btn-dark shadow-none" data-bs-dismiss="modal">Register</button>
                    </div>
                    <!-- <div class="mb-3">
                      <label class="form-label">Email address</label>
                      <input type="email" class="form-control shadow-none">
